...
AUTH_CHANNEL = [int(ch) for ch in str(AUTH_CHANNEL).strip().split()] if AUTH_CHANNEL else []

AUTH_REQ_CHANNEL = environ.get('AUTH_REQ_CHANNEL', '-1002429510787 -1002116325676')
AUTH_REQ_CHANNEL = [int(ch) for ch in str(AUTH_REQ_CHANNEL).strip().split()] if AUTH_REQ_CHANNEL else []
